...
export function AgentLogin() {
  ...
  const handleLogin = () => {
    ...
    if (agent) {
      ...
      setCurrentUser({ id: agent.id, name: agent.name, role: agent.role });
      notify.success(`Welcome, ${agent.name}!`);
      
      if (agent.role === 'cashier') {
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 p-8">
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl text-white mb-2">Agent Login</h2>
              ...
              <div className="space-y-6">
                ...
                >
                  <label className="block text-sm text-gray-300 mb-2">Agent ID</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 backdrop-blur-xl focus:outline-none focus:border-purple-500/50 transition-colors"
                    />
                  </div>
                </motion.div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-purple-500 to-pink-600 text-white relative overflow-hidden group"
                >
                ...
                <div className="text-center mt-4">
                  <p className="text-sm text-gray-400">Default Agent: 7777 / 12345678</p>
                </div>
              </div>
            </div>
          </div>
